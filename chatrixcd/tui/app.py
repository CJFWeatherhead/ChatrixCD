...
class ChatrixTUI(App):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if use_color and theme in self.THEMES:
            ...
            # Even when using unknown theme names, ensure CSS is set with defaults
            theme_values = self.THEMES.get(theme, self.THEMES['default'])
            try:
    ...
    def _apply_theme(self, theme_name: str):
        ...
        self.design = ColorSystem(
            ...
            # Textual will auto-generate other colors
        )
    ...
    def get_css_variables(self) -> dict:
        ...
        scrollbar_keys = [
            ...
            'scrollbar-background-active', 'scrollbar', 'scrollbar-hover',
            'scrollbar-active', 'scrollbar-corner-color'
        ]
    ...
    async def _load_plugin_screens(self):
        ...
        if isinstance(loaded_plugins, Mapping):
            ...
            logger.debug("plugin_manager.loaded_plugins is not a mapping; skipping plugin screen loading")
            return
