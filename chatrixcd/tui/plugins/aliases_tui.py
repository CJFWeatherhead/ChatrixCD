...
from chatrixcd.tui.plugin_integration import PluginTUIExtension, PluginScreenMixin
...
class AliasesScreen(BaseScreen, PluginScreenMixin):
    ...
    def compose_content(self):
        ...
        with Container(classes="aliases-container"):
            yield Static("[bold cyan]Command Aliases[/bold cyan]", classes="section-header")
            yield Static(
            ...
            yield DataGrid(
                columns=["Alias", "Command", "Actions"],
                id="aliases-table"
            )
            
            with Horizontal(classes="action-buttons"):
                yield Button("Add Alias", id="add-alias", variant="primary", classes="action-btn")
                yield Button("Delete Selected", id="delete-alias", variant="error", classes="action-btn")
                yield Button("Refresh", id="refresh", variant="default", classes="action-btn")
