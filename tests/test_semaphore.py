...
class TestSemaphoreClient(unittest.TestCase):
    ...
    def test_start_task_success(self):
        ...
        async def mock_json():
            return {"id": 123, "template_id": 1, "status": "waiting"}
            ...
            return [
                {
                    "id": 0,
                    "task_id": 123,
                    "time": "2025-11-06T17:35:21.360703911Z",
                    "output": "",
                },
                {
                    "id": 1,
                ...
                },
                {
                    "id": 2,
                    "task_id": 123,
                    "time": "2025-11-06T17:35:21.366692799Z",
                    "output": "",
                },
                {
                    "id": 3,
                ...
                },
                {
                    "id": 4,
                    "task_id": 123,
                    "time": "2025-11-06T17:35:21.38092541Z",
                    "output": "\u001b[0;33mchanged: [localhost]\u001b[0m",
                },
            ]
