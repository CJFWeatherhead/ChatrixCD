...
class TestPetScoldAliases(unittest.TestCase):
    ...
    def test_pet_is_reserved_command(self):
        ...
        try:
            ...
            self.assertFalse(result, "Should not be able to alias 'pet' (it's a reserved command)")
    ...
    def test_scold_is_reserved_command(self):
        ...
        try:
            ...
            self.assertFalse(result, "Should not be able to alias 'scold' (it's a reserved command)")
